...
function onStepHit()
    if curStep == 257 then
        ...
        doTweenAlpha('enginetextalpha', 'engineTxt', 0, 1)
        doTweenAlpha('composertextalpha', 'composerTxt', 0, 1)
        doTweenAlpha('messagetextalpha', 'messageTxt', 0, 1)
    ...
    if curStep == 319 then
        ...
        doTweenAlpha('enginetextalpha', 'engineTxt', 1, 1)
        doTweenAlpha('composertextalpha', 'composerTxt', 1, 1)
        doTweenAlpha('messagetextalpha', 'messageTxt', 1, 1)
